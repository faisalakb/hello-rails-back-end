...
```sh
  ...
  git clone https://github.com/faisalakb/hello-rails-back-end
...
Feel free to check the [issues page](https://github.com/faisalakb/hello-rails-back-end/issues).
...
This project is [MIT](https://github.com/faisalakb/hello-rails-back-end/blob/dev/LICENSE) licensed.
